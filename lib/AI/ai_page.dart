...
class _AiPageState extends State<AiPage> with TickerProviderStateMixin {
  // textEditingController for messages
  final TextEditingController _messageController = TextEditingController();

  //scroll controller
  final ScrollController _scrollController = ScrollController();

  // This is list of Message Objects
  ...
  //chatsession to have a context of previous chats with in the session
  ...
  void initState() {
    ...
    //Initializing the Gemini model with API Key
    // final String? apiKey = dotenv.env["GEMINI_API_KEY"];
    final String? apiKey = "AIzaSyDog6W2RrxYWS_yiPznjlWsA-1Kb8sOzNs";

    if (apiKey == null) {
      //Handle the Error if API key is not found
          ...
          Flexible(
            child: Container(
              ...
              child: message.isUser
                  ...
                  //       textStyle: TextStyle(
                  //         color: Colors.red, // Custom color for LaTeX
                  //         fontSize: 20, // Custom font size for LaTeX
                  //         fontWeight: FontWeight.bold,
                  //       ),
                  //     ),
                  //   ),
